...
// module.exports = requestHandler; // Export the requestHandler function so it can be used in other files
// We can also export an object with multiple properties, allowing us to export multiple things from this module
module.exports = {
  handler: requestHandler,
  someText: "Some hard coded text",
};

//we can also export multiple things using the module.exports object
// module.exports.handler = requestHandler; // Export the requestHandler function
// module.exports.someText = "Some hard coded text"; // Export some text
